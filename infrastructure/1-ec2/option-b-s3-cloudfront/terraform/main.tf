...
# ALB Listener - Default returns 404 (frontend served by CloudFront)
resource "aws_lb_listener" "http" {
  ...
  default_action {
    ...
    fixed_response {
      ...
      message_body = "Not Found - Frontend is served via CloudFront. Use CloudFront URL for the application."
      status_code  = "404"
    }
  }
}
